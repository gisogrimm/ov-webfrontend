...
if( !empty($device) ){
  ...
  }
  {
    ...
    $el = $divex->appendChild($doc->createElement('div'));
    $el->setAttribute('class','devproptitle');
    xml_add_checkbox( 'spkcalib_use', 'Headphone equalization', $el, $doc, $devprop, false, true );
    $divex = add_expert_div($divex,$doc,$devprop,'spkcalib_use');
    $el = $divex->appendChild($doc->createElement('div'));
    ...
    $el = xml_add_input_generic( 'spkcalib_vfreq','Frequency vector (space separated) in Hz:',$divex,$doc,$devprop);
    $el->setAttribute('type','text');
    $el->setAttribute('style','width:100%;');
    $el->setAttribute('value',$devprop['spkcalib_vfreq']);
    $el = xml_add_input_generic( 'spkcalib_vgainl','Gain vector left (space separated) in dB:',$divex,$doc,$devprop);
    $el->setAttribute('type','text');
    $el->setAttribute('style','width:100%;');
    $el->setAttribute('value',$devprop['spkcalib_vgainl']);
    $el = xml_add_input_generic( 'spkcalib_vgainr','Gain vector right (space separated) in dB:',$divex,$doc,$devprop);
    $el->setAttribute('type','text');
    $el->setAttribute('style','width:100%;');
    $el->setAttribute('value',$devprop['spkcalib_vgainr']);
    // head tracking:
    $divex = add_expert_div($div,$doc,$devprop);
    $el = $divex->appendChild($doc->createElement('div'));
    $el->setAttribute('class','devproptitle');
